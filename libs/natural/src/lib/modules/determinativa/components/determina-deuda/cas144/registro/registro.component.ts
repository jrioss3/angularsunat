...
import { C144RegistroFormService } from './registro-form.service';
...
export class C144RegistroComponent implements OnInit {
  ...
  constructor(public activeModal: NgbActiveModal,
    public registroForm: C144RegistroFormService,
  ...
  public ngOnInit(): void {
    ...
    this.tributoDescripcion =  ConstantesTributos.RENTA_TRABAJO.descripcion;
  ...
  public guardar(): void {   
    ...
    if (!guardar) {
      this.spinner.show();
      this.pagosPreviosService.obtenerPago(this.registroForm.fieldNroOrden.value, this.registroForm.fieldFormulario.value, ConstantesTributos.RENTA_TRABAJO.codigo)
        .subscribe(data => {
          this.spinner.hide();
          const modelo = {
